    ...
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} className="flex-1 bg-white dark:bg-zinc-900">
      <View className="flex-1 justify-center px-6">
        <View className="items-center mb-10">
          ...
          <Text className="text-3xl font-bold text-gray-900 dark:text-white">CropChain</Text>
          <Text className="text-base text-gray-500 dark:text-gray-400 mt-1">Sign in to your account</Text>
        </View>
        ...
        >
          ...
          <Text className="text-gray-700 dark:text-gray-300 font-semibold ml-2">Connect Wallet</Text>
        </TouchableOpacity>
