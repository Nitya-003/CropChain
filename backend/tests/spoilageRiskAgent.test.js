...
describe("Spoilage Risk Prediction Agent", () => {
  ...
  it("should query active transit batches, analyze risk, save to DB, and emit socket updates", async () => {
    ...
    const mockBatch = {
      ...
      toJSON: jest
        .fn()
        .mockReturnValue({ batchId: "CROP-2026-0001", cropType: "tomato" }),
    };
    ...
    expect(mockBatch.spoilageRisk.factors).toEqual([
      "High temperature for Tomato",
      "Transit duration exceeded",
    ]);
