...
const MULTISIG_ACTIONS = {
  ...
  BATCH_CONTAMINATED: {
    ...
    requiredApprovals:
      parseInt(process.env.MULTISIG_CONTAMINATED_APPROVALS, 10) || 3,
    requiredRole: ROLES.QUALITY_INSPECTOR,
    expiresInHours:
      parseInt(process.env.MULTISIG_CONTAMINATED_EXPIRY, 10) || 12,
  },
  BATCH_DESTROY: {
    action: "batch_destroy",
    description: "Authorize batch destruction",
    requiredApprovals:
      parseInt(process.env.MULTISIG_DESTROY_APPROVALS, 10) || 3,
    requiredRole: ROLES.QUALITY_INSPECTOR,
  ...
  BATCH_QUALITY_CHECK: {
    ...
    requiredApprovals:
      parseInt(process.env.MULTISIG_QUALITY_CHECK_APPROVALS, 10) || 2,
    requiredRole: ROLES.QUALITY_INSPECTOR,
    expiresInHours:
      parseInt(process.env.MULTISIG_QUALITY_CHECK_EXPIRY, 10) || 24,
  },
};
