...
const cropRecommendationSchema = Joi.object({
  ...
  N: Joi.number()
    ...
    .required()
    .messages({
      "number.base": "N (Nitrogen) must be a number",
      "any.required": "N (Nitrogen) is required",
    }),
  ...
  P: Joi.number()
    ...
    .required()
    .messages({
      "number.base": "P (Phosphorus) must be a number",
      "any.required": "P (Phosphorus) is required",
    }),
  ...
  K: Joi.number()
    ...
    .required()
    .messages({
      "number.base": "K (Potassium) must be a number",
      "any.required": "K (Potassium) is required",
    }),
  ...
  humidity: Joi.number()
    ...
    .required()
    .messages({
      "number.base": "humidity must be a number (percentage)",
  ...
  rainfall: Joi.number()
    ...
    .required()
    .messages({
      "number.base": "rainfall must be a number (mm)",
