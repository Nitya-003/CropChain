...
const mockBatchService = {
  async getBatch(batchId) {
    if (batchId === 'CROP-2024-0001') {
      return {
        ...
        updates: [
          { stage: 'farmer', actor: 'Test Farmer', location: 'Test Village', timestamp: '2024-01-15', notes: 'Initial harvest recorded' },
          { stage: 'mandi', actor: 'Test Mandi', location: 'Test Mandi Center', timestamp: '2024-01-16', notes: 'Arrived at mandi' }
        ],
        lifecycle: {
          currentStage: 'Quality Checked',
          stageHistory: [
            { stage: 'Registered', timestamp: '2024-01-15', updatedBy: 'Test Farmer', notes: 'Registered' },
            { stage: 'Quality Checked', timestamp: '2024-01-16', updatedBy: 'Quality Inspector', notes: 'Passed quality checks successfully' }
          ]
        }
      };
    }
  ...
  async searchBatches(filters) {
    ...
    if (batch) {
      ...
      if (filters.farmerName && !batch.farmerName.includes(filters.farmerName)) return [];
      return [batch];
    }
    return [];
  },
