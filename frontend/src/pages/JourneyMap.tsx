...
import { ArrowLeft, Compass, Info, ShieldCheck, AlertTriangle } from 'lucide-react';
...
const JourneyMap: React.FC = () => {
  ...
  const selectedUpdate = updates[selectedUpdateIndex];
      ...
      <div className="journey-grid-container">
        ...
        <div className="flex flex-col space-y-4">
          <div className="journey-glass-card rounded-2xl p-6">
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-6 border-b border-gray-100 dark:border-gray-850 pb-4 flex items-center gap-2">
        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="journey-glass-card rounded-2xl p-6 text-left">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 text-xs">
              <div className="bg-gray-50 dark:bg-gray-800/40 p-2.5 rounded-xl border border-gray-100 dark:border-gray-850">
