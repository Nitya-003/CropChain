...
describe("Header", () => {
  ...
  it("renders navigation links", async () => {
    ...
    await renderHeader();
    expect(screen.getAllByText("nav.home")[0]).toBeInTheDocument();
    expect(screen.getAllByText("nav.trackBatch")[0]).toBeInTheDocument();
    expect(screen.getAllByText("nav.smartPlanting")[0]).toBeInTheDocument();
  });
