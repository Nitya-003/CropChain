...
export const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center p-8 text-center rounded-2xl bg-gray-50 dark:bg-gray-800/50 border-2 border-dashed border-gray-200 dark:border-gray-700 ${className}`}
    >
      {Icon && (
