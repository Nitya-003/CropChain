...
export const ErrorState: React.FC<ErrorStateProps> = ({
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center p-8 text-center rounded-2xl bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-900/30 ${className}`}
    >
      ...
      <p className="text-red-600 dark:text-red-300 max-w-sm mb-6">{message}</p>
      {onRetry && (
        <button
          onClick={onRetry}
