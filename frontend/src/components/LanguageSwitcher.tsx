...
const LanguageSwitcher: React.FC = () => {
  ...
  return (
    <div className="relative group">
      <button
        className="flex items-center space-x-2 px-3 py-1.5 rounded-lg border border-border bg-background dark:bg-card hover:bg-muted text-foreground transition-all duration-200 h-9 text-xs font-semibold"
