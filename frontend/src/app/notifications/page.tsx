...
export default function NotificationsPage() {
  ...
  const getBgColorForType = (type: string, read: boolean) => {
    ...
    switch (type) {
      ...
      case "recall":
        return "bg-rose-500/10 border-rose-500/30 dark:bg-rose-500/5";
      default:
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-1 sm:gap-4">
                  <h4
                    className={`font-bold text-base truncate ${notification.read ? "text-foreground" : "text-foreground"}`}
                  >
                    {notification.title}
                  </h4>
                ...
                <p
                  className={`mt-1 text-sm ${notification.read ? "text-muted-foreground" : "text-foreground font-medium"}`}
                >
