              ...
              <div className="mt-2.5 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-150 dark:border-gray-650 space-y-1.5 text-xs">
                ...
                <div className="grid grid-cols-2 gap-x-2 gap-y-1 font-mono">
                  <span
                    className={
                      password.length >= 8
                        ? "text-green-600 dark:text-green-400 flex items-center font-medium"
                  ...
                  <span
                    className={
                      /[^A-Za-z0-9]/.test(password)
                        ? "text-green-600 dark:text-green-400 flex items-center font-medium col-span-2"
                        : "text-gray-400 flex items-center col-span-2"
                    }
                  >
                    <span className="mr-1">
                      {/[^A-Za-z0-9]/.test(password) ? "✓" : "○"}
